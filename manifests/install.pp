class corp104_memcached_exporter::install inherits corp104_memcached_exporter {
  ...
  $options = "-scrape_uri=\"${corp104_memcached_exporter::scrape_uri}\" ${corp104_memcached_exporter::extra_options}"
  ...
  case $corp104_memcached_exporter::install_method {
    'url': {
      ...
      archive { "/tmp/${corp104_memcached_exporter::package_name}-${corp104_memcached_exporter::version}.tar.gz":
        ...
        creates         => "/opt/${corp104_memcached_exporter::package_name}-${corp104_amemcached_exporter::version}.linux-${os_arch}/${corp104_memcached_exporter::package_name}",
        cleanup         => true,
